...
const Footer = () => {
    return (
        <div className='absolute w-full bottom-0 top-full'>
        <footer className="footer p-10 bg-base-200 text-base-content">
            <div>
                <span className="footer-title">Services</span> 
                <a href='/xyz' className="link link-hover">Branding</a> 
                <a href='/xyz' className="link link-hover">Design</a> 
                <a href='/xyz' className="link link-hover">Marketing</a> 
                <a href='/xyz' className="link link-hover">Advertisement</a>
            </div> 
            <div>
